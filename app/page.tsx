    ...
    <main className="page">
      ...
      <section className="portada">
        ...
        <div className="portada-overlay">
          ...
          <div className="portada-botones top">
            <Link href="/propiedades?operation=sale" className="btn-clean">
              Comprar <span className="arrow">→</span>
            </Link>
            <Link href="/propiedades?operation=rental" className="btn-clean">
              Vender <span className="arrow">→</span>
            </Link>
          </div>
        </div>
      </section>
      ...
      <section className="portada-bottom">
        <div className="portada-botones bottom">
          <Link href="/propiedades" className="btn-clean">
            Residencial <span className="arrow">→</span>
          </Link>
          <Link href="https://cademaprop.com.ar/parque-industrial/" className="btn-clean">
            Industrias <span className="arrow">→</span>
          </Link>
        </div>
      </section>
