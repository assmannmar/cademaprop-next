          ...
          {reviews.map((review, idx) => (
            <div key={idx} className="w-full flex-shrink-0">
              <div className="bg-white p-8 rounded-lg shadow-lg border border-gray-100 text-center">
                ...
                <p className="text-xl text-gray-700 italic mb-6 leading-relaxed">"{review.text}"</p>
                <h4 className="font-bold text-gray-900 uppercase tracking-wider">- {review.author_name}</h4>
              </div>
            </div>
          ))}
        </div>
