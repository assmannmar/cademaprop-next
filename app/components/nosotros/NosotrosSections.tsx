...
const valores = [
  ...
  },
  {
    ...
    description:
      "Respaldamos cada operación con más de 60 años de experiencia y conocimiento del mercado.",
  },
  {
    icon: (
      <svg className="w-12 h-12" fill="currentColor" viewBox="0 0 20 20">
    ...
    title: "Innovación",
    description:
      "Aplicamos tecnología y nuevas ideas para estar siempre un paso adelante.",
  },
  {
    icon: (
      <svg className="w-12 h-12" fill="currentColor" viewBox="0 0 20 20">
...
export function NosotrosIntro({ showCta = false }: { showCta?: boolean }) {
  return (
    <section className="nosotros-intro">
      <div className="nosotros-intro-wrap">
        ...
        <div className="nosotros-intro-card">
          ...
          <p>
            Nos destacamos por construir relaciones sólidas y duraderas, basadas
            en la transparencia, la confianza y la eficiencia.
          </p>
          ...
          {showCta && (
            <div className="nosotros-intro-actions">
...
export function NosotrosValuesSection() {
  return (
    <section className="nosotros-values">
      <div className="nosotros-values-container">
        ...
        <div className="nosotros-values-grid">
          {valores.map((valor) => (
            <article key={valor.title} className="nosotros-value-card">
              <div className="nosotros-value-icon">{valor.icon}</div>
...
export function NosotrosServicesSection() {
  return (
