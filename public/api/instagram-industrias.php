...
$accessToken = api_secret('INSTAGRAM_INDUSTRIAS_ACCESS_TOKEN', INSTAGRAM_INDUSTRIAS_ACCESS_TOKEN);
if ($accessToken === '') {
    json_response(['posts' => []]);
}

$posts = cached_json('instagram_industrias', 3600, function () use ($accessToken) {
